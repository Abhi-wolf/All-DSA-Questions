...
bool canMakeSubsequence(string str1, string str2)
{
    ...
    for (int str1ind = 0; str1ind < lenstr1 && str2ind < lenstr2;
         ++str1ind)
    {
        if (str1[str1ind] == str2[str2ind] ||
            str1[str1ind] + 1 == str2[str2ind] ||
            str1[str1ind] - 25 == str2[str2ind])
            str2ind++;
    }

    return str2ind == lenstr2;
}

int main()
{
    string str1 = "abc", str2 = "ad";
    cout << "Result = " << canMakeSubsequence(str1, str2) << endl;
    return 0;
}