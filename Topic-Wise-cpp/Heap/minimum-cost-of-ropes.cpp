...
ropes is equal to sum of their lengths.
...
(we get three rope of 3, 2 and 10), then connect 10 and 3 (we get two rope of 13 and 2). Finally we
...
62
Explanation:
First, connect ropes 4 and 2, which makes the array {6,7,6,9}. Cost of this operation 4+2 = 6. Next, add ropes
6 and 6, which results in {12,7,9}. Cost of this operation 6+6 = 12.
...
Your Task:
You don't need to read input or print anything. Your task is to complete the function minCost() which takes an
integer array arr[] and an integer n as arguments and returns the minimum cost.
